...
public class Get01 {
    ...
    /*
    Bizler bu zamana kadar sizler ile birlikte POSTMAN üzerinde farklı doc. sahip olan cesitli API lere request attik.
    REq atarken HTTP methodlarin da GET , POST; PUT , PATCH and DELETE methodlarını kullandik
...
/*
     ...
     */
    @Test  // it is like  it main method (main method gibi)
    public  void get01(){
        /*
        4 tane adimimiz var

        1. URL  i set etmem lazim

        2. Expected datalari tanimlamam lazim Expected dataları set etmem lazim
        Expected datalari TEST  CASE den alınir. Doc. dan alinir( Suan icin buu step ignore edilecektir)
       ...
       //Step 1 : URL i set ediniz https://restful-booker.herokuapp.com/booking/7
        ...
        //Step 2 :   Expected datalari Set et(Ignore edilmistir
    ...
    And
        ...
        response.then().assertThat().statusCode(200);  // Doc. TestCase den alınmistir
