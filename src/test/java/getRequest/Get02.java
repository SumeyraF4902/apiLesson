...
public class Get02 {
    ...
    String URL=" https://restful-booker.herokuapp.com/booking/78100";
        ...
        response.prettyPrint();   // prettyPrint()  like it   syso gibidir


        // Assertion işlemlerini yaparken temelde iki farklı metot kullanıyoruz  bunları  seleniumda  Apiumda, Apı da kullanabiliriz
        // a) Hard Assertion
        // b) Soft Assertion
